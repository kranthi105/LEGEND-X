...
HELP_STRINGS = f"""
*Main Commands :* [LÊGÉÑD X](https://telegra.ph/file/7dd4f3f246fad2772db33.jpg)
...
def LEGEND_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            text=f"*😍 Hi again!  The name's {dispatcher.bot.first_name} 😍 \n\nAs  You I'm a next generational group management bot developed by @SR9981395097.* "
        ...
        query.message.edit_text(
            ...
            f"\n\n{dispatcher.bot.first_name}'s source code was rewritten by @SR9981395097"
        ...
        query.message.edit_text(
            ...
            f"\n✪ Always try to keep credits, so \n  This hardwork is done by @SR9981395097 spending many sleepless nights.. So, Respect it."
